...
public class MyCartShop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_cart_shop);
    ...
    private void GetData() {
        DatabaseReference getData = ref.child("Users").child(curUser).child("My Cart");
    ...
    private void GetShopName(String key) {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                str.add(key+"*"+value);
                recyclerView.setAdapter(new MyCartShopAdapter(MyCartShop.this, str));
            }
